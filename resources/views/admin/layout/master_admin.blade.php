                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="/images/sm/{{Auth::user()->photo->path}}" class="user-image" alt="User Image">
                            @endif
                            <span class="hidden-xs">{{Auth::user()->family}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                @if(isset(Auth::user()->photo))
                                <img src="/images/sm/{{Auth::user()->photo->path}}" class="img-circle" alt="User Image">
                                @endif
                                <p>
                                    {{Auth::user()->family}}
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-right image">
                    @if(isset(Auth::user()->photo))
                    <img class="circle-img" src="/images/sm/{{Auth::user()->photo->path}}">
                    @endif
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>تعیین سطوح دسترسی</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('roles.index')}}"><i class="fa fa-circle-o"></i>نقش ها</a></li>
                        <li><a href="{{route('permissions.index')}}"><i class="fa fa-circle-o"></i>سطوح دسترسی</a></li>
                        <li><a href=""><i class="fa fa-circle-o"></i>افزودن کاربر(مدیر)</a></li>
                    </ul>
                </li>
                @endCan
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.post.create')}}"><i class="fa fa-circle-o"></i>پست جدید</a></li>
                        <li><a href=""><i class="fa fa-circle-o"></i>مدیریت پست ها</a></li>
                        <li><a href=""><i class="fa fa-circle-o"></i>انتخاب پست ها</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>لیست کدها</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/adminstator/orders')}}"><i class="fa fa-circle-o"></i>لیست سفارشات</a></li>
                    </ul>
                </li>
            </ul>
        </section>
