            ...
            <div dir="ltr" class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                <div class="ui-block">
                    ...
                    <div class="friend-item">
                        ...
                        <a href="{{route('classmates.college' , ['slug'=>$major->slug])}}" class="photo-item college">
                        ...
                        <div class="friend-item-content">
                            ...
                            <div class="friend-avatar bg-text-image">
                                <div class="author-content">
                                    <a href="{{route('classmates.college' , ['slug'=>$major->slug])}}" class="h5 author-name fs0-9">دانشکده {{$major->title}}</a>
                                </div>
                            </div>
